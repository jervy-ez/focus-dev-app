    ...
    <table class="table table-striped table-hover invoice-table">
      ...
      <tbody>
        <tr>
          ...
          <td><strong><div class="m-top-5">$<span class="total_cost_progress variation_total_cost"><?php echo number_format($variation_total); ?></span> ex-gst</div></strong></td>
          <td>
          ...
          <div class="row">
            ...
            <div class="col-sm-12 border-bottom">
              ...
              <div class="clearfix col-sm-6">
                <p>Total Ex-GST: $<strong class="po_total_mod">00000</strong></p>
              </div>
              <div class="clearfix col-sm-6">
                <p>Total Inc-GST: $<strong class="po_total_mod_inc_gst">00000</strong></p>
              </div>
            ...
            <div class="col-sm-6">
              <div class="clearfix">
                ...
                <div class="col-sm-9">
                  <div class="input-group m-bottom-10">
                    <span class="input-group-addon" id="">$</span>
                    <input type="text" placeholder="Amount" class="form-control number_format" id="progress_payment_amount_value_inc_gst" name="progress_payment_amount_value_inc_gst" value="" tabindex="2">
