  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body clearfix pad-10">
        ...
        <input type="hidden" class="invoice_percent_value">

        <div class="m-bottom-10">
          <textarea class="form-control" id="invoice_notes" name="invoice_notes" placeholder="Invoice Notes" rows="6"></textarea>
        </div>
