              ...
              <div class="clearfix m-top-15">
                ...
                <div class="col-sm-9">
                  <div class="input-group m-bottom-10">
                    ...
                    <input type="text" placeholder="Amount" class="form-control number_format amount_ext_gst" id="amount_ext_gst" name="" value="" tabindex="2">
            ...
            <div class="col-sm-6">
              <div class="clearfix">
                ...
                <div class="col-sm-9">
                  <div class="input-group m-bottom-10">
                    <span class="input-group-addon" id="">$</span>
                    <input type="text" placeholder="Amount" class="form-control number_format amount_inc_gst" id="amount_inc_gst" name="" value="" tabindex="2">
