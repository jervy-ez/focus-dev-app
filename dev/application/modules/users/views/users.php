					...
					<div class="col-md-12">
						<div class="left-section-box">
							<div class="box-head pad-10 clearfix">
								<a href="./users/add" class="btn btn-primary pull-right"><i class="fa fa-briefcase"></i>&nbsp; Add New</a>
									...
									<div class="row clearfix pad-left-15  pad-right-15 pad-bottom-10">
										...
										<?php foreach($users as $key => $user): ?>
												...
												<div class="col-md-6 col-sm-6 col-lg-4 col-xs-12 box-widget">
													<div class="box <?php echo ($user->department_name == 'Administrator' ? 'wid-type-d' : 'wid-type-c'); ?>">
														...
														<?php else: ?>
															...
															<div class="box-area pad-5 text-left">
																<div style="float: left; overflow: hidden; height: 90px; ">
																	<img src="./uploads/users/<?php echo $user->user_profile_photo; ?>" style="margin: 5px 5px; width: 85px;">
																</div>
