...
*/
	...
	public function update_joinery_markup($joinery_id, $mark_up){
		$this->db->query("UPDATE `work_joinery` set `work_markup`= '$mark_up' where work_joinery_id = '$joinery_id'");
	}
	...
	public function display_selected_works_joinery($works_joinery_id){
		$query = $this->db->query("SELECT *, a.company_client_id as work_joinery_contractor_id, a.price as wj_price, a.work_reply_date as wj_work_reply_date, a.work_markup as joinery_markup
