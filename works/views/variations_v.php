<?php 
	...
	$variation_id = $this->session->flashdata('variation_id');
?>
					...
					<div class="col-md-9">
						<div class="">
							<div class="box-head pad-bottom-10 clearfix">
								...
								<p><a href="" id = "back_to_variation"><i class = "fa fa-hand-o-left"></i> Back to Variation List</a></p>
					...
					<div class="col-md-3" id = "frmcontractor">
						<div class="box">
							<div class="box-head pad-5">
								...
								<button type="button" id="btnadd_var_contractor" class ="btn btn-primary pull-right" data-toggle="modal" data-target="#add_var_Contractor_Modal">Add</button>
							</div>
