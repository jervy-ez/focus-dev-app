					...
					<div class="clearfix" id = "edit_work_desc">
						...
						<div class="col-sm-8">
							...
							<div class="input-group">
								<select id="worktype" class="form-control chosen"  tabindex="5" name="worktype" style = "display: none">													
								...
								<input type="text" id = "other_work_description" name = "other_work_description" class = "form-control" value = "<?php echo $work_desc ?>" placeholder = "Type Work Description here..">
				...
				<?php endif; ?>
						...
						<div class="rows">
								...
								<div class="rows">
											...
											<div class="box m-bottom-5">
												...
												<div class="panel-body clearfix" style = "height: 213px">
													<div id="work_date">
														...
														<p class="col-sm-12"><strong>Goods Delivered by:</strong>: <span class="data-street"><?php echo $good_deliverby_date; ?></span></p>
													</div>
													<div class = "col-sm-12" id = "edit_work_date">
														<div class="col-sm-5">
															<div class="clearfix m-bottom-10">
																<label for="work_replyby_date" class="col-sm-5 control-label" style = "font-size: 12px">Reply By:</label>
																<div class="col-sm-7">
														...
														<div class="col-sm-7">
															<div class="clearfix m-bottom-10">
																<label for="work_replyby_date" class="col-sm-5 control-label" style = "font-size: 12px">Goods Deliver by:</label>
																<div class="col-sm-7">
									...
									<div class="col-sm-12">
										<div class="box m-bottom-10">
											...
											<div class="pad-5">
												<textarea class="form-control m-bottom-10" id="update_work_notes" rows="6" tabindex="32" name="work_notes" style="resize: vertical;  overflow: auto;"><?php echo $notes ?></textarea>
							...
							<div class="col-sm-3">
								...
								<div class="box m-bottom-5">
									<div class="box-head pad-5 m-bottom-5">
										<?php if($this->session->userdata('projects') >= 2): ?><button type = "button" id = "edit_work_attachment" class = "btn-xs btn btn-warning pull-right"><i class = "fa fa-pencil-square-o"></i> Edit</button><?php endif; ?>
										<button type = "button" id = "save_work_attachment" class = "btn-xs btn btn-success pull-right"><i class = "fa fa-save"></i>  Save</button>
										<label><i class = "fa fa-paperclip fa-lg"></i> Work Attachments</label>
									</div>
									<div class="panel-body clearfix" style = "height: 200px">
										<div id = "work_attachment_type_list">
											<?php 
												foreach ($work_attachment_type->result_array() as $row){
													echo "* ".$row['attachment_type'].'</br>';
												}
											?>
											
										</div>
										<div id = "edit_work_attachment_type_list">
											<?php 
												foreach ($attachment_type->result_array() as $row){
											?>
												<input type="checkbox" name = "work_attachment_type" value = "<?php echo $row['attachment_type_id'] ?>" <?php 
																																foreach ($work_attachment_type->result_array() as $wa_row){
																																	if($row['attachment_type_id'] == $wa_row['attachment_type_id']){
																																		echo "checked";
																																	}
																																}
																															?>>
											<?php
													echo $row['attachment_type'];
													echo "</br>";
												}
											?>
