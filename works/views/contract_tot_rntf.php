...
foreach ($project_t->result_array() as $row){
	...
	$pdf->Cell(30,10,'Quotaion and Contract:',0,0);
	...
	foreach ($invoice_q->result_array() as $inv_row){
		...
		$pdf->cell(15,10,$inv_row['progress_percent'].' %');
		$pdf->cell(5,10,'$');
	...
	if($focus_comp == "Focus Shopfit Pty Ltd"){
		...
		$comp_name_nsw = "Focus Shopfit Pty Ltd";
		$comp_add_nsw_1 = "Unit 4/340 Chrisholm Road";
		$comp_add_nsw_2 = "Auburn NSW 2144";
		$comp_add_nsw_3 = "PO Box 1172 Menai";
		$comp_add_nsw_4 = "Central NSW 2234";
		$comp_add_nsw_5 = "ABN 17 164 759 102";
	}
