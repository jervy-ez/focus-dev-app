...
class User_model extends CI_Model{	
	...
	public function update_user_details($user_id,$login_name,$user_first_name,$user_last_name,$user_skype,$user_skype_password,$user_gender,$user_date_of_birth,$department_id,$user_focus_company_id,$user_comments_id,$profile,$supervisor_id){
		$query = $this->db->query("UPDATE `users` SET `login_name` = '$login_name', `user_first_name` = '$user_first_name', `user_last_name` = '$user_last_name',`user_profile_photo`='$profile',`user_comments_id` = '$user_comments_id', `user_skype` = '$user_skype',`user_skype_password` = '$user_skype_password',`user_focus_company_id`='$user_focus_company_id', `user_gender`='$user_gender',`user_date_of_birth`='$user_date_of_birth',`user_department_id` = '$department_id', `supervisor_id` = '$supervisor_id'  WHERE `users`.`user_id` = '$user_id' ");
	}
