	...
	var app = new Vue({
        ...
        methods: {
        	...
        	viewPDF: function(project_id,a){
        		...
        		switch(a){
        			case 1:
        				this.pdfFile = "../uploads/project_induction_slides/"+project_id+"/slide1.pdf";
        				break;
        			case 2:
        				this.pdfFile = "../uploads/project_induction_slides/"+project_id+"/slide2.pdf";
        				break;
        			case 3:
        				this.pdfFile = "../uploads/project_induction_slides/"+project_id+"/slide3.pdf";
        				break;
        			case 4:
        				this.pdfFile = "../uploads/project_induction_slides/"+project_id+"/slide4.pdf";
        				break;
        			case 5:
        				this.pdfFile = "../uploads/project_induction_slides/"+project_id+"/slide5.pdf";
        				break;
        			case 6:
        				this.pdfFile = "../uploads/project_induction_slides/"+project_id+"/slide6.pdf";
        				break;
        		}
        	},
