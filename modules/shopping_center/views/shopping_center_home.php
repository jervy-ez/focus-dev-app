						...
						<div class="<?php echo ($this->session->userdata('projects') >= 2 ? 'col-md-9' : 'col-sm-12'); ?>">
							<div class="left-section-box">
								...
								<div class="box-area pad-10">
									<table id="shoppingCenterTable" class="table table-striped table-bordered" cellspacing="0" width="100%"><thead><tr><th>Brand/Shopping Centre Group</th><th>Common Name</th><th>Street</th><th>Suburb</th><th>State</th></tr></thead>
										<tbody>
...
<?php if($this->session->userdata('shopping_centre') >= 2 ): ?>
						...
						<div class="col-md-3">
							...
							<div class="box add-shopping-center">
								...
								<div class="box-area clearfix pad-5">
									...
									<strong class="m-left-5 m-top-10"> Either of the brand or the common name is Required*</strong>
										...
										<div class="clearfix  m-bottom-10 <?php if(form_error('brand')){ echo 'has-error has-feedback';} ?>">
											...
											<div class="col-sm-12">
												<input type="text" class="form-control m-top-10 upper_c_each_word" id="brand" name="brand" tabindex="1" placeholder="Brand/Shopping center" value="<?php echo $this->input->post('brand'); ?>">
											</div>
										</div>
										...
										<div class="clearfix m-top-10 m-bottom-10">
											...
											<div class="col-sm-8">
												<input type="text" class="form-control upper_c_each_word" id="common_name" name="common_name" tabindex="2" placeholder="Common Name" value="<?php echo $this->input->post('common_name'); ?>">
											</div>
										</div>
										...
										<div class="clearfix m-top-10 m-bottom-10">
											...
											<div class="col-sm-8">
												<input type="text" class="form-control upper_c_each_word" id="street-number" name="street_number" tabindex="3" placeholder="Street Number" value="<?php echo $this->input->post('street_number'); ?>">
											</div>
										</div>
										...
										<div class="clearfix m-top-10 m-bottom-10 <?php if(form_error('street')){ echo 'has-error has-feedback';} ?>">
											...
											<div class="col-sm-8">
												<input type="text" class="form-control upper_c_each_word" id="street" name="street" tabindex="4" placeholder="Street" value="<?php echo $this->input->post('street'); ?>">
											</div>
										</div>
								...
								<div class="box-area clearfix pad-5">
									<form class="form-horizontal update-shopping" role="form" method="post"  action="shopping_center/update">
										...
										<div class="clearfix  m-bottom-10">
											...
											<div class="col-sm-12">
												<input type="text" class="form-control m-top-10 upper_c_each_word" id="edit_brand" name="edit_brand" tabindex="8" placeholder="Brand/Shopping center" value="">
											</div>
										</div>

										<div class="clearfix m-top-10 m-bottom-10">
											<label for="edit_common_name" class="col-sm-4 control-label text-left" style="font-weight: normal;">Common Name</label>
											<div class="col-sm-8">
												<input type="text" class="form-control upper_c_each_word" id="edit_common_name" name="edit_common_name" tabindex="9" placeholder="Common Name" value="<?php echo $this->input->post('edit_common_name'); ?>">
											</div>
										</div>
										...
										<div class="clearfix m-top-10 m-bottom-10">
											...
											<div class="col-sm-8">
												<input type="text" class="form-control upper_c_each_word" id="edit_street_number" name="edit_street_number" tabindex="10" placeholder="Street Number" value="">
											</div>
										</div>
										...
										<div class="clearfix m-top-10 m-bottom-10 ">
											...
											<div class="col-sm-8">
												<input type="text" class="form-control upper_c_each_word" id="edit_street" name="edit_street" placeholder="Street" tabindex="11" value="<?php echo $this->input->post('street'); ?>">
											</div>
										</div>
										...
										<div class="clearfix m-top-10 m-bottom-10">
											...
											<div class="col-sm-8">
												<select class="form-control state-option-b chosen edit_state_b"  id="state_b" tabindex="12" name="edit_state_a">															
													<option value="">Choose a State</option>
													<?php
													foreach ($all_aud_states as $row){
														echo '<option value="'.$row->shortname.'|'.$row->name.'|'.$row->phone_area_code.'|'.$row->id.'">'.$row->name.'</option>';
										...
										<div class="clearfix m-top-10 m-bottom-10">
											...
											<div class="col-sm-8">
												<select class="form-control suburb-option-b chosen edit_suburb_a" id="suburb_b" tabindex="13" name="edit_suburb_a">
										...
										<div class="clearfix m-top-10 m-bottom-10">
											...
											<div class="col-sm-8">												
												<select class="form-control postcode-option-b chosen" id="postcode_b" tabindex="14" name="edit_postcode_b">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="col-sm-12 m-bottom-10 clearfix">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control upper_c_each_word" id="contact_f_name" placeholder="First Name" name="contact_f_name" value="">
							</div>
						</div>
						...
						<div class="col-sm-12 m-bottom-10 clearfix">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control upper_c_each_word" id="contact_l_name" placeholder="Last Name" name="contact_l_name" value="">
							</div>
						</div>
						...
						<div class="col-sm-7 m-bottom-10 clearfix">
							...
							<div class="col-sm-10">
								<input type="email" class="form-control upper_c_each_word" id="cotact_email" placeholder="Email" name="cotact_email" value="">
							</div>
						</div>
						...
						<div class="col-sm-12 m-bottom-10 clearfix">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control upper_c_each_word" id="contact_number" placeholder="Number" name="contact_number" value="">
							</div>
						</div>
...
<div style="display:none;" class="state_select_list">
	<div class="input-group m-bottom-10 pull-right m-left-10" style="width: 220px;">
