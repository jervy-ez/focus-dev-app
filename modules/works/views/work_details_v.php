								...
								<div class="box m-bottom-5">
									...
									<div class="panel-body">
										<div id = "work_desc" class="m-bottom-10 clearfix <?php if(form_error('worktype')){ echo 'has-error has-feedback';} ?>">
											...
											<div class="col-sm-9">
												<select id="worktype" class="form-control chosen"  tabindex="4" name="worktype">												
												...
												<select id="other_work_category" class="form-control chosen other_work_category" tabindex="5" name="other_work_category" style = "display: none">												
							...
							<div class="col-sm-12">
								<div class="box m-bottom-10">
									...
									<div class="pad-10">
										...
										<textarea class="form-control m-bottom-10" id="work_notes" rows="6" cols="5000" tabindex="21" name="work_notes" style="resize: vertical;  overflow: auto;"  <?php if($job_category == "Maintenance"){ ?>maxlength = '1470'<?php } ?>><?php echo $this->input->post('work_notes'); ?></textarea>
