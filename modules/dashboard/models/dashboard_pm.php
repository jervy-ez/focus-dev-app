								...
								<div class="widget wid-type-e small-widget">
									<div class="box-area clearfix">
										...
										<div class="widg-content fill col-xs-9 clearfix">
											<div class="pad-5">
												<div class=" " id=""><p>Invoiced <span class="pull-right"><?php echo date('Y'); ?></span> <span class="pointer" ><i class="fa fa-info-circle tooltip-enabled" title="" data-html="true" data-placement="top" data-original-title="Tells how much is been invoiced from begining of the year to date."></i></span> <span class="pull-right"><?php echo date('Y'); ?></span></p></div>
								...
								<div class="box-area clearfix">
									<div class="widg-content clearfix">
										...
										<div class="pad-10" id="">
											...
											<style type="text/css">.knob_box canvas{width: 100% !important;}.knob{font-size: 80px !important; }</style>
