...
<tr>
  ...
  <td valign="top" width="30%" ><div style="padding-left:15px;"><p style="text-align:center;"><strong>Average Final Invoice Days</strong></p><div class="donut_style" style="margin:0 auto;"><?php echo $this->dashboard->average_date_invoice_pm($pm_id,$report_year); ?></div></div></td>
</tr>
</table>
...
<?php if($pm_id == 29): ?>
  <?php echo $this->dashboard->focus_top_ten_clients_mn('',$report_year); ?>

  
<?php else: ?>


  <?php echo $this->dashboard->focus_top_ten_clients_pm($pm_id,$report_year,'list'); ?>
...
<?php if($pm_id == 29): ?>
  <?php echo $this->dashboard->focus_top_ten_clients_mn('pie',$report_year); ?>

  
<?php else: ?>


  <?php echo $this->dashboard->focus_top_ten_clients_pm($pm_id,$report_year,'pie'); ?>
