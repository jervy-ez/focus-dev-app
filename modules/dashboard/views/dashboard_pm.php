										...
										<div role="tabpanel" class="tab-pane active fade in" id="clients" >
											...
											<div id="" class="col-lg-7">
												<div id="" class="" style="height: 300px; overflow: auto;">
													<?php echo $this->dashboard->focus_top_ten_clients(); //focus_top_ten_clients_pm ?>
												</div>
											</div>
										</div>
...
var donuta = c3.generate({
	size: {
		...
		columns: [ <?php   $this->dashboard->focus_top_ten_clients_donut(); //focus_top_ten_clients_pm_donut ?> ],
		type : 'pie',
