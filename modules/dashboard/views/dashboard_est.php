						...
						<div class="col-md-12 col-sm-12 col-xs-12 col-lg-6 box-widget pad-10">
							<div class="widget wid-type-0 widg-head-styled">
								...
								<div class="widg-head box-widg-head pad-5 fill">
									...
									<script type="text/javascript"> $('select.chart_data_selection_est').val('<?php echo strtolower($es_f_name); ?>');</script>
								</div>
        ...
        $(function() {
            $("#est_deadline_<?php echo $est_name_list; ?>").gantt({
                ...
                onRender: function() {
                	...
                	<?php if($es_f_name == $est_name_list): ?>
                		$('#est_deadline_<?php echo $est_name_list; ?>').show();
                	<?php else: ?>
								...
								<div class="box-area clearfix" style="height:320px;">
									<div class="widg-content clearfix">
										...
										<div id="" class="pad-5" style="">
											...
											<script type="text/javascript"> pre_load_module('#focus_projects_by_type_widget_area','dashboard/focus_projects_by_type_widget',10500); </script>
											<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 box-widget m-top-10 text_display_dyn" id="focus_projects_by_type_widget_area">
												<p style=" padding: 2px 0px 3px;"><i class="fa fa-cog fa-spin fa-fw margin-bottom"></i> Loading...</p>
