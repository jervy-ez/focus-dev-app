...
<div class="canvas_area editor_body">
 <table width="100%">
  <tr>
    <td width="50%"><img src="https://sojourn.focusshopfit.com.au/img/logo.png" width="192" height="95" /></td>
...
<div class="full clearfix c_edit">
  ...
  <div style="float:right !important; width:50% !important;">
    <div class="pad-l-10">
      <fieldset class="pad-10 border-1 mgn-top-10">
        ...
        <div class="full clearfix invoices_list_item mgn-top-10 j_edit">
      ...
      <?php if($include_invoice_comments == 1): ?>
           <p>&nbsp;</p>
        <p style="color:red;" ><strong>Invoice Comments<br /><?php echo nl2br(htmlspecialchars($invoice_comments)); ?></strong></p>
  ...
  <div style="float:left !important; width:50% !important;">
    <div class="pad-r-5">
      <fieldset class="pad-10 border-1 mgn-top-10">
        ...
        <div class="clearfix mgn-top-10 j_edit">
          <p class="clearfix"><span class="pull-left block text-left">Representative :</span> &nbsp; &nbsp; <strong class="pull-right block text-right"><?php echo "$pm_user_first_name $pm_user_last_name"; ?></strong></p>
          <p class="clearfix"><span class="pull-left block text-left">Job Date : </span>&nbsp; &nbsp; <strong class="pull-right block text-right"><?php echo $job_date; ?></strong></p>
          <p class="clearfix"><span class="pull-left block text-left">Start Date : </span>&nbsp; &nbsp;  <strong class="pull-right block text-right"><?php echo $date_site_commencement; ?></strong></p>
          <p class="clearfix"><span class="pull-left block text-left">Expected Finish Date : </span>&nbsp; &nbsp;  <strong class="pull-right block text-right"><?php echo $date_site_finish; ?></strong></p>
          <p class="clearfix"><span class="pull-left block text-left">PO Number :</span> &nbsp; &nbsp; <strong class="pull-right block text-right"><?php echo $client_po; ?></strong></p>
        </div>
      </fieldset>
      <p>&nbsp;</p>
