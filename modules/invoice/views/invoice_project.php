    ...
    <table class="table table-striped table-hover invoice-table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td colspan="2"><strong><div class="m-top-5">$<span class="total_cost_progress"><?php echo number_format($project_grand_total_in,2); ?></span> ex-gst &nbsp; &nbsp; $<span class="total_cost_progress"><?php echo number_format($project_grand_total_in+($project_grand_total_in*($admin_gst_rate/100))); ?></span> inc-gst</div></strong></td>
          <td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body clearfix pad-10">
        ...
        <form method="post" action="<?php echo base_url(); ?>invoice/set_invoice_progress">
          ...
          <div class="m-bottom-10">
            <textarea class="form-control" id="invoice_notes" name="invoice_notes" placeholder="Job Book Notes" rows="6"></textarea>
          </div>
          <div class="pull-right" style="width:100%;">
            ...
            <button type="button" class="btn btn-primary set_invoice_modal_submit pull-right m-right-10" data-toggle="modal" data-target="#loading_modal" data-backdrop="static" >Submit</button>
              ...
              <div class="clearfix m-top-15">
                ...
                <div class="col-sm-9">
                  <div class="input-group m-bottom-10">
                    ...
                    <input type="text" placeholder="Amount" class="form-control" id="progress_payment_amount_value" name="progress_payment_amount_value" value="" tabindex="2">
            ...
            <div class="col-sm-6">
              <div class="clearfix">
                ...
                <div class="col-sm-9">
                  <div class="input-group m-bottom-10">
                    <span class="input-group-addon" id="">$</span>
                    <input type="text" placeholder="Amount" class="form-control" id="progress_payment_amount_value_inc_gst" name="progress_payment_amount_value_inc_gst" value="" tabindex="2">
