	...
	<div class="row">				
		...
		<div class="section col-sm-12 col-md-11 col-lg-11">
				<div class="container-fluid">
                              ...
                              <tbody>
                                ...
                                <?php $this->invoice->invoice_table(); ?>  
											...
											<div class="tab-pane clearfix" id="paid">
												<div class="m-bottom-15 clearfix">
                          <div class="box-area">  
                            <p style="margin: 10px;">The paid invoices list is moved, You can click <a class="btn btn-xs btn-info" href="<?php echo base_url(); ?>invoice/paid">Here</a> to view full list.</p>
                  ...
                  table#invoice_future_table_dynamic th,table#invoice_future_table_dynamic   tbody#dynamic_future_body td {    font-size: 14px;}</style>
...
<?php if($this->session->userdata('is_admin') == 1 || $this->session->userdata('user_role_id') == 5 || $this->session->userdata('user_role_id') == 6  || $this->session->userdata('invoice') == 2 ): ?>
