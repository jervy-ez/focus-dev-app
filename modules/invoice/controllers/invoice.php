...
class Invoice extends MY_Controller{
	function __construct(){
		...
		if(isset($_GET['submit_invoice'])){
			...
			redirect('projects/view/'.$project_id.'?tab=invoice'); // by Mike
		}
...
/*
$send_to = 'jervy@focusshopfit.com.au';
$pm_user_email = 'jervyezaballa@gmail.com';
*/
		// PHPMailer class
		$mail = new PHPMailer;
		//$mail->SMTPDebug = 3;                               		// Enable verbose debug output
...
if($total_paid == 0 && $this->session->userdata('is_admin') == 1 ):
	...
	if($row->is_paid == 1){
		...
		echo '<a class="btn btn-primary  m-right-10" href="'.base_url().'docs/inv_jbs/'.$file_name.'" target="_blank"><i class="fa fa-files-o"></i> View Job Book</a>';
	}
