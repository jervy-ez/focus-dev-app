...
public function client_supply_report(){
	...
	switch ($supply_status) {
		...
		$data_filter .= " <strong>Status</strong> : Inbound &nbsp;  &nbsp;  &nbsp; ";
		$supply_status_selected = 'Inbound';
		break;

		case "2":
		$custom .= " AND `client_supply`.`is_delivered_date` IS NULL AND `client_supply`.`date_goods_arrived` != '' ";
		$data_filter .= " <strong>Status</strong> : Outbound &nbsp;  &nbsp;  &nbsp; ";
		...
		$data_filter .= " <strong>Status</strong> : Completed &nbsp;  &nbsp;  &nbsp; ";
		$supply_status_selected = 'Completed';
		break;
		
		default:
		$custom .= ' ';
		$data_filter .= " <strong>Status</strong> : All Status &nbsp;  &nbsp;  &nbsp; ";
	...
	if($warehouse_delivery_a != '' || $warehouse_delivery_b != ''){
		$data_filter .= " <strong>Delivery Date To Warehouse</strong> : $warehouse_delivery_a - $warehouse_delivery_b   &nbsp;  &nbsp;  &nbsp; ";
	}
	...
	if($goods_arrived_a != '' || $goods_arrived_b != ''){
		$data_filter .= " <strong>Date Goods Arrived</strong> : $goods_arrived_a - $goods_arrived_b   &nbsp;  &nbsp;  &nbsp; ";
	}
	...
	if($delivery_to_site_a != '' || $delivery_to_site_b != ''){
		$data_filter .= " <strong>Delivery To Site Date</strong> : $delivery_to_site_a - $delivery_to_site_b   &nbsp;  &nbsp;  &nbsp; ";
	}
	...
	if($completed_delivery_a != '' || $completed_delivery_b != ''){
		$data_filter .= " <strong>Completed Date</strong> : $completed_delivery_a - $completed_delivery_b  &nbsp;  &nbsp;  &nbsp; ";
	}
	...
	$content .= '<div class="def_page"><div class="clearfix header"><img src="./img/focus-logo-print.png" align="left" class="block" style="margin-top:-30px; " /><h1 class="text-right block"  style="margin-top:-10px; margin-bottom:10px;" ><br />'.$supply_status_selected.' Supply Report</h1></div><br />';
	$content .= '<table id="" class="table table-striped table-bordered" cellspacing="0" width="100%"><thead><tr>';
	...
	if($project_manager_csply != ''){
		$content .= '<strong>Project Manager: </strong>'.$pm_selected_arr[1].' &nbsp;  &nbsp;  &nbsp;  ';
	}

	
	$content .= '<strong> Supplies Found :</strong> '.$records_num.' &nbsp;  &nbsp;  &nbsp; ';
	$content .= $data_filter.'';
	$content .= '<br /><strong> Legend :</strong>  &nbsp;  &nbsp; <span style="background:#BEF5BE; color:#000; padding:3px;">&nbsp; Delivered &nbsp;</span>  &nbsp; &nbsp; &nbsp; <span style="background:#FFC6C6; color:#000; padding:3px;">&nbsp; Overdue Delivery &nbsp;</span>';
...
//	if($doc_type == 'pdf'){
		...
		$my_pdf = $this->html_form($content,'landscape','A4','client_supply','temp');
		echo $my_pdf;
/*	}else{
		$content = $csv_content;
		$log_time = time();
...
public function process_wip_review(){
	...
	$content .= '<p>This report displays the Previous Week prior to the last WIP Review.<br/>WIP Reviews are completed each week by Wednesday midnight.<br /></p>';
