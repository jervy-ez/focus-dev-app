...
//		$content .= '<tr><td colspan="5">'.$status.' '.$type.' '.$wip_client_q.' '.$wip_pm_q.' '.$selected_cat_q.' '.$order_q.'</td></tr>';
		...
		$content .= '<p><br /><hr /><span><strong> All Prices are EXT-GST</strong> &nbsp; &nbsp; '.$this->wip->sum_total_wip_cost($arrs).'</span><br /></p><p><br /><span><strong>Project Manager:</strong> '.$wip_pm_filter.'</span></p>';
