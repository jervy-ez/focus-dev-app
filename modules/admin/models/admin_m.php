...
class Admin_m extends CI_Model{
	...
	public function get_archive_types(){
		$query = $this->db->query(" SELECT * FROM `archive_registry_types` WHERE `archive_registry_types`.`is_active` = '1' ");
		return $query;
	}
...
*/
	...
	public function update_leave_request_to_disabled($user_id){
		$query = $this->db->query("UPDATE `leave_request` SET `is_active` = '0', `is_disabled` = '1' WHERE `user_id` = '$user_id'");
	}
