...
class Admin_m extends CI_Model{
	...
	public function update_static_settings($days_psswrd_exp,$temp_user_psswrd,$annual_leave_daily_rate,$sl_days,$pl_carers_days,$pl_compasionate_days){
		$query = $this->db->query("UPDATE `static_defaults` SET `days_psswrd_exp` = '$days_psswrd_exp', `temp_user_psswrd` = '$temp_user_psswrd', `annual_leave_daily_rate` = '$annual_leave_daily_rate', `sl_days` = '$sl_days', `pl_carers_days` = '$pl_carers_days', `pl_compasionate_days` = '$pl_compasionate_days' WHERE `static_defaults`.`static_defaults_id` = 1 ");
	}
	...
	public function insert_rate_set($rate_set_name,$normal_rate,$time_half_rate,$double_time_rate,$double_time_half_rate,$travel_allowance,$meal_allowance,$lafh_allowance){
		...
		$this->db->query("INSERT INTO `employee_rate_set` 
								(`rate_set_name`,`normal_rate`,`time_half_rate`,`double_time_rate`,`double_time_half_rate`,`travel`,`meal`,`living_away_from_home`) 
