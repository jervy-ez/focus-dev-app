...
//		$data['postal_address_id'] = $company_detail['postal_address_id'];
	...
	public function default_email_message_induction(){
		...
		$this->admin_m->update_admin_default_email_message_induction_video($sender_name_induction,$sender_email_induction,$subject_induction,$email_msg_induction_video,$bcc_email_induction,$user_id);
