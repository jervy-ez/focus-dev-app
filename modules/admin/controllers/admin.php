...
//		redirect('/admin');
	...
	public function user_settings(){
		...
		$this->form_validation->set_rules('sl_days', 'Sick Leave Days','trim|required|xss_clean');
		$this->form_validation->set_rules('pl_carers_days', 'Personal Leave - Carers','trim|required|xss_clean');
		$this->form_validation->set_rules('pl_compasionate_days', 'Personal Leave - Compasionate','trim|required|xss_clean');
		...
		if($this->form_validation->run() === false){
			...
			$sl_days = $this->input->post('sl_days', true);
			$pl_carers_days = $this->input->post('pl_carers_days', true);
			$pl_compasionate_days = $this->input->post('pl_compasionate_days', true);

			$this->admin_m->update_static_settings($days_exp,$temp_password,$annual_leave_daily_rate,$sl_days,$pl_carers_days,$pl_compasionate_days);
			$update_success = 'The User Accounts Setting is now updated.';
