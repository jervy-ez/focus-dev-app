								...
								<div class="col-lg-6 col-md-6 col-sm-8">
									<div class="pad-top-15 pad-right-15 pad-bottom-5 clearfix box-tabs">	
										<ul id="myTab" class="nav nav-tabs pull-right">
											<li class="active"><a href="#defaults" id="defaults_btn" role="tab" data-toggle="tab" aria-controls="defaults" aria-expanded="true"><i class="fa fa-cog fa-lg"></i> Admin Defaults</a></li>
											...
											<li><a href="#users" id="uers_btn" role="tab" data-toggle="tab" aria-controls="users" aria-expanded="true"><i class="fa fa-users fa-lg"></i> Users</a></li>
										</ul>
									</div>
								</div>
							</div>
...
<!-- Hour Rate Cost Inc On Costs -->
								...
								<div class="tab-pane fade in active" id="defaults" aria-labelledby="defaults">
