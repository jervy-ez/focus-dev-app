                    ...
                    <div class="btn-group" role="group">
                      ...
                      <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                        ...
                        <?php if(isset($_GET['status'])): ?>
                          <li><a href="?status=<?php echo $_GET['status']; ?>&fompj=0">View All</a></li>
                          <?php foreach ($focus as $key => $value): ?>                         
                            <li><a href="?status=<?php echo $_GET['status']; ?>&fompj=<?php echo $value->company_id; ?>"><?php echo $value->company_name; ?></a></li>
                          <?php endforeach; ?>

                        <?php else: ?>
                          <li><a href="?fompj=0">View All</a></li>

                          <?php foreach ($focus as $key => $value): ?>                         
                            <li><a href="?fompj=<?php echo $value->company_id; ?>"><?php echo $value->company_name; ?></a></li>
                          <?php endforeach; ?>
                  ...
                  <?php endif; ?>
                    ...
                    <div class="btn-group" role="group">
                      ...
                      <ul class="dropdown-menu" aria-labelledby="prj_status_btn">
                        ...
                        <li><a href="?status=all">All Status</a></li>
                        <li><a href="?status=wip">WIP</a></li>
                        <li><a href="?status=quote">Quotes</a></li>
                        <li><a href="?status=unset">Unaccepted Quotes</a></li>
                        <li><a href="?status=invoiced">Invoiced</a></li>
                        <li><a href="?status=paid">Paid</a></li>
                        <li><a href="?status=warranty">Warranty</a></li>
