	      								...
	      								<div class="box m-bottom-15 clearfix">
											...
											<div class="box-area pad-5 clearfix">																																
												...
												<div class="col-sm-6 m-bottom-10 clearfix <?php if(form_error('site_start')){ echo 'has-error has-feedback';} ?>">
													...
													<div class="col-sm-9">
														<input tabindex='6' type="text" data-date-format="dd/mm/yyyy" placeholder="DD/MM/YYYY" title="Warning: Changing Site Start Date when project is already in WIP or Previously in WIP, will reset its labour shed." class="tooltip-enabled form-control datepicker" id="site_start" name="site_start" tabindex="4" value="<?php echo ($this->input->post('site_start') ?  $this->input->post('site_start') : $date_site_commencement ); ?>">
													</div>
												</div>
												...
												<div class="col-sm-6 col-xs-12 m-bottom-10 clearfix <?php if(form_error('site_finish')){ echo 'has-error';} ?>">
													...
													<div class="col-sm-9 col-xs-12">
														<input tabindex='7' type="text" data-date-format="dd/mm/yyyy" placeholder="DD/MM/YYYY" title="Warning: Changing Site Start Date when project is already in WIP or Previously in WIP, will reset its labour shed." class="tooltip-enabled form-control datepicker" id="site_finish" name="site_finish" tabindex="4" value="<?php echo ($this->input->post('site_finish') ?  $this->input->post('site_finish') : $date_site_finish ); ?>">
													</div>
												</div>
											</div>
										</div>
