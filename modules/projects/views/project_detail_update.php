										...
										<div class="form-group clearfix pad-5 no-pad-b">
	      								...
	      								<div class="box m-bottom-15 clearfix">
											...
											<div class="box-area pad-5 clearfix">																																
												...
												<div class="col-sm-6 m-bottom-10 clearfix <?php if(form_error('sub_client_id')){ echo 'has-error has-feedback';} ?>">
...
<?php echo ($shopping_center_brand_name != '' ? $shopping_center_brand_name : $shopping_common_name); 															echo ', '.$unit_number.' '.$street.', '.ucwords(strtolower($suburb)).', '.$state.', '.$postcode; ?>
