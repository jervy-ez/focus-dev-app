...
<div class="container-fluid">
 ...
 -->
																	...
																	<label for="site_start" class="col-sm-4 control-label m-top-5 text-left">Site Start</label>
																		<div class="col-sm-8  col-xs-12">
																			<input tabindex="6" type="text" data-date-format="dd/mm/yyyy" title="Warning: Changing Site Start Date when project is already in WIP or Previously in WIP, will reset its labour shed, and will also change date range of of Project Schedule." placeholder="DD/MM/YYYY" class="tooltip-enabled quick_input form-control text-right datepicker" id="site_start" name="site_start" value="<?php echo $date_site_commencement; ?>">
																		</div>
																	</div>
																	...
																	<label for="site_finish" class="col-sm-4 control-label m-top-5 text-left">Site Finish</label>
																		<div class="col-sm-8  col-xs-12">
																			<input tabindex="7" type="text" data-date-format="dd/mm/yyyy" title="Warning: Changing Site Start Date when project is already in WIP or Previously in WIP, will reset its labour shed, and will also change date range of of Project Schedule." placeholder="DD/MM/YYYY" class="tooltip-enabled quick_input form-control text-right datepicker" id="site_finish" name="site_finish" value="<?php echo $date_site_finish; ?>">
																		</div>
																	</div>
															...
															<div class="row">
																...
																<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 m-bottom-10 clearfix">
																	<div class="pad-15 no-pad-t">
																		...
																		<?php $ps_shop_tenancy_numb = ($job_type != 'Shopping Center' ? '' : ''.$shopping_center_brand_name.': '.$shop_tenancy_number ); ?>
...
/*
										...
										<div class="tab-pane fade in  clearfix <?php echo ($curr_tab == 'attachments' ? 'active' : '' ); ?>" id="attachments">
											<div class="m-bottom-15 clearfix m-top-10">
												<?php if($curr_tab == 'attachments'){echo $this->attachments->attachments_view();} ?>
											</div>
										</div>
