...
<div class="container-fluid">
 ...
 -->
																	...
																	<label for="site_start" class="col-sm-4 control-label m-top-5 text-left">Site Start</label>
																		<div class="col-sm-8  col-xs-12">
																			<input tabindex="6" type="text" data-date-format="dd/mm/yyyy" title="Warning: Changing Site Start Date when project is already in WIP or Previously in WIP, will reset its labour shed." placeholder="DD/MM/YYYY" class="tooltip-enabled quick_input form-control text-right datepicker" id="site_start" name="site_start" value="<?php echo $date_site_commencement; ?>">
																		</div>
																	</div>
																	...
																	<label for="site_finish" class="col-sm-4 control-label m-top-5 text-left">Site Finish</label>
																		<div class="col-sm-8  col-xs-12">
																			<input tabindex="7" type="text" data-date-format="dd/mm/yyyy" title="Warning: Changing Site Start Date when project is already in WIP or Previously in WIP, will reset its labour shed." placeholder="DD/MM/YYYY" class="tooltip-enabled quick_input form-control text-right datepicker" id="site_finish" name="site_finish" value="<?php echo $date_site_finish; ?>">
																		</div>
																	</div>
