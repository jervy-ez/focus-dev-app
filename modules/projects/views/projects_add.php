								...
								<?php endif; ?>
									...
									<div class="box-head pad-10 clearfix">
										<div class="pull-right">
											...
											<script type="text/javascript">$('.focus').val('<?php echo ($this->input->post('focus') ? $this->input->post('focus') : $this->session->userdata('user_focus_company_id')); ?>').trigger('change');</script>
	      								...
	      								<div class="box m-bottom-15 clearfix">
											...
											<div class="box-area pad-5 clearfix">																																
												...
												<div class="col-sm-6 m-bottom-10 clearfix <?php if(form_error('brand_name')){ echo 'has-error has-feedback';} ?>">
													...
													<div class="col-sm-9">		  
															<select name="brand_name" class="form-control brand" id="brand" style="width: 100%;" tabindex="2">
												...
												<div class="col-sm-6 m-bottom-10 clearfix <?php if(form_error('job_category')){ echo 'has-error has-feedback';} ?>">
													...
													<div class="col-sm-9  col-xs-12">
														...
														<select class="form-control tooltip-test" id="job_category" name="job_category" tabindex='4' data-original-title="On selecting the Job Category, Project Area is only optional if Job Category is Strip Out, Minor Works or Maintenance.">															
												...
												<div class="col-sm-6 m-bottom-10 clearfix <?php if(form_error('site_start')){ echo 'has-error has-feedback';} ?>">
													...
													<div class="col-sm-9">
<input tabindex='6' type="text" placeholder="DD/MM/YYYY" class="form-control" id="site_start" name="site_start" tabindex="4" value="<?php echo $this->input->post('site_start'); ?>" autocomplete="off">
													</div>
												</div>
												...
												<div class="col-sm-6 col-xs-12 m-bottom-10 clearfix <?php if(form_error('site_finish')){ echo 'has-error';} ?>">
													...
													<div class="col-sm-9 col-xs-12">
<input tabindex='7' type="text" placeholder="DD/MM/YYYY" class="form-control" id="site_finish" name="site_finish" tabindex="4" value="<?php echo $this->input->post('site_finish'); ?>" autocomplete="off">
													</div>
												</div>
											</div>
										</div>
...
$("select.select-focus").on("change", function(e) { 
	...
	if(selct_foc == 3197 && selct_jbcat != 'Maintenance'){
	...
	$('option.def_slct_optn').hide();
									    ...
									    <div class="m-top-15 clearfix">
									    	<div>
									        	...
									        	<div class="btn-group">
									        		<button type="submit" class="btn btn-success pull-left"  data-toggle="modal" data-target="#loading_modal" data-backdrop="static"  ><i class="fa fa-floppy-o"></i> Save</button>
