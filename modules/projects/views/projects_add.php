											...
											<div class="box-area pad-5 clearfix">																																
												...
												<div class = "maintenance_site_cont_form">
													<div class="col-sm-6 m-bottom-10 clearfix <?php if(form_error('site_start')){ echo 'has-error has-feedback';} ?>">
														...
														<div class="col-sm-9">
															<input tabindex='6' type="text" placeholder="Contact Person Name" class="form-control" id="site_cont_person" name="site_cont_person">
														</div>
													</div>
													...
													<div class="col-sm-6 m-bottom-10 clearfix <?php if(form_error('site_start')){ echo 'has-error has-feedback';} ?>">
														...
														<div class="col-sm-9">
															<input tabindex='6' type="text" placeholder="Contact Number" class="form-control" id="site_cont_number" name="site_cont_number">
														</div>
													</div>
													...
													<div class="col-sm-6 m-bottom-10 clearfix <?php if(form_error('site_start')){ echo 'has-error has-feedback';} ?>">
														...
														<div class="col-sm-9">
															<input tabindex='6' type="text" placeholder="Contact Person Mobile" class="form-control" id="site_cont_mobile" name="site_cont_mobile">
														</div>
													</div>
													...
													<div class="col-sm-6 m-bottom-10 clearfix <?php if(form_error('site_start')){ echo 'has-error has-feedback';} ?>">
														...
														<div class="col-sm-9">
															<input tabindex='6' type="text" placeholder="Contact E-mail" class="form-control" id="site_cont_email" name="site_cont_email">
														</div>
													</div>
												</div>
