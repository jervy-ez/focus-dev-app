												...
												<div class="col-md-12">
													<div class="pad-15 no-pad-t">	
														...
														<!-- <div class="col-md-9"> -->
															<div class="box">
																<div class="box-head pad-5">
																	...
																	<div class="si_char_count_wrap"><input type="text" id="si_char_count" class="text-right" name="si_char_count" size="3" maxlength="3" value="420" readonly> character remaining</div>
																</div>
																
																<div class="box-area pad-5 clearfix">
																	<div class="clearfix <?php //if(form_error('generalEmail')){ echo 'has-error has-feedback';} ?>">
																		
																			<textarea class="form-control" id="site_inspection_details" rows="7" tabindex="1" name="site_inspection_details" onkeydown="textCounter(this.form.site_inspection_details, this.form.si_char_count);" onkeyup="textCounter(this.form.site_inspection_details, this.form.si_char_count);"><?php echo $sr_details->site_inspection_details; ?></textarea>														
														...
														<!-- <div class="col-md-9"> -->
															<div class="box">
																<div class="box-head pad-5">
																	...
																	<div class="completion_char_count_wrap"><input type="text" id="completion_char_count" class="text-right" name="completion_char_count" size="3" maxlength="3" value="420" readonly> character remaining</div>
																</div>
																
																<div class="box-area pad-5 clearfix">
																	<div class="clearfix <?php //if(form_error('generalEmail')){ echo 'has-error has-feedback';} ?>">
																		<div class="">
																			<textarea class="form-control" id="completion_details" rows="7" tabindex="1" name="completion_details" onkeydown="textCounter(this.form.completion_details, this.form.completion_char_count);" onkeyup="textCounter(this.form.completion_details, this.form.completion_char_count);"><?php echo $sr_details->completion_details; ?></textarea>														
																		</div>
																	</div>
																</div>
															</div>
														...
														<div class="col-md-12 pad-10 m-top-20">
															<div class="col-md-offset-4 col-md-2 m-bottom-5">
																<button type="button" id="btnGenerate_SR_pdf" class="btn btn-success btn-block"><i class = "fa fa-file-pdf-o fa-lg"></i> Save and Generate</button>
															</div>
					</form>
