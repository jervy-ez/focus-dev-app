				...
				<div class="row">
				    ...
				    <div class="col-md-10">
				    	...
				    	<select class="form-control chosen" id="sendpdf_main_to" name="leading_hand" tabindex="1">	
				    		...
				    		<option value="0|michael@focusshopfit.com.au"><?php echo $pm_user_first_name.' '.$pm_user_last_name.' (PM) - '.$pm_email; ?><strong></option>
				    		<option value="1|mike.coros@yahoo.com"><?php echo $contact_person_fname.' '.$contact_person_lname.' (Client) - '.$contact_person_email; ?></option>
				    		<option value="michael@focusshopfit.com.au, mike.coros@yahoo.com">Both <?php echo $pm_user_first_name.' '.$pm_user_last_name.' (PM)'; ?> and <?php echo $contact_person_fname.' '.$contact_person_lname.' (Client)'; ?></option>
						</select>
