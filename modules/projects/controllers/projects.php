...
//		
	...
	public function send_pr_pdf(){
		...
		$body_content .= '<span style="font-family: "Calibri, Candara, Segoe, Segoe UI, Optima, Arial, sans-serif"><br>Regards,<br><br><strong>'.$this->session->userdata('user_first_name').' '.$this->session->userdata('user_last_name').'</strong><br><br>'.$this->session->userdata('role_types').'<br><span style="color: "#FF3399";>'.$sendpdf_from.'</span></span><br><br>';
