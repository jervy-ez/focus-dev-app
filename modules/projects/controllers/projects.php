...
//		
	...
	public function progress_report_pdf() {
		...
		if ($this->input->post('const_mngr') == 'other-offsite-superv'){
			$data['const_mngr'] = $this->input->post('const_mngr_label_hidden');
		} else {
	...
	public function update_pr_details(){
		...
		$name_const_mngr = ucwords($pr_details[4]);
		$mobile_no_const_mngr = $pr_details[5];
		...
		$this->projects_m->update_pr_details($scope_of_work, $project_id);
