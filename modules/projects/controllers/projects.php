...
//		
	...
	public function service_report() {
		...
		$check_sr_details = $this->projects_m->check_sr_details($project_id);

		if($check_sr_details->num_rows == 0){
			
			$insert_blank_sr_details = $this->projects_m->insert_blank_sr_details($project_id, '1');
		}
	...
	public function service_report_pdf() {
		...
		$this->projects_m->update_sr_details($data['project_id'], $data['site_inspection_details'], $data['completion_details']);
