 <div class="app-main__inner">
    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                <div class="page-title-icon">
                    <i class="fas fa-tachometer-alt icon-gradient bg-orange-gradient">
                    </i>
                </div>
                <div>Analytics Dashboard
                    <div class="page-title-subheading">Every managers tool.</div>
                </div>
            </div>
            ...
            <div class="card mb-3 widget-content bg-midnight-bloom">
                <div class="widget-content-wrapper text-white">
                    <div class="widget-content-left">
                        ...
                        <div class="widget-subheading">This is a test widget for dashboard.</div>
                    </div>
        ...
        <div class="col-md-6 col-xl-4 hide">
