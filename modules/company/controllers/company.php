...
//++++++++++++++++++++++++++++++++++++++++++++++++++
	...
	public function add_cont_site_staff(){
		$ss_fname = $_POST['ss_fname'];
		$ss_sname = $_POST['ss_sname'];
		$ss_position = $_POST['ss_position'];
		$company_id = $_POST['company_id'];
		$mobile_number = $_POST['ss_mobile_no'];
		$ss_email = $_POST['ss_email'];
		$is_apprentice = $_POST['is_apprentice'];
	...
	public function update_cont_site_staff(){
		...
		$ss_sname = $_POST['ss_sname'];
		$ss_position = $_POST['ss_position'];
		$contractor_site_staff_id = $_POST['contractor_site_staff_id'];
		$mobile_number = $_POST['ss_mobile_no'];
		$ss_email = $_POST['ss_email'];
		$company_id = $_POST['company_id'];
...
//Site staff functions end ====================================
	...
	public function onboarding_send(){
		...
		// 	} else {
				...
				$onboarding_insert_id = $this->company_m->insert_onboarding_data($onboarding_email_address, $onboarding_first_name, $onboarding_last_name, $onboarding_message);
				...
				$onboard_mailer->addBCC('michael@focusshopfit.com.au');
	...
	public function onboard_approved(){
		...
		if($company_type_id == 2):
			...
			foreach ($default_msg_q->result_array() as $row){
				...
				$sender_name = $row['sender_name'];
				$sender_email = $row['sender_email'];
				$bcc_email = $row['bcc_email'].",insurance@focusshopfit.com.au,marko@focusshopfit.com.au,michael@focusshopfit.com.au";
