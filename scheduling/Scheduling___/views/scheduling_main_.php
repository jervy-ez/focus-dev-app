...
<div class="content-wrapper">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              <div class="row" id="">
                ...
                <div class="col-md-2" id="">
                  <select class="form-control" id="class_block">
                    ...
                    <?php foreach ($class_block as $data):?>
                       <option value="<?php echo $data->id; ?>"><?php echo $data->block_code.'-'.$data->year_level.' '.$data->block; ?></option>
                    <?php endforeach; ?>
                ...
                <input class="form-control" value="<?php echo $course_details->credit_units; ?>" id="class_units" placeholder="Units">
  ...
  <div class="modal fade success_added_schedule" id="success_added_schedule" tabindex="-1" role="dialog">
...
$('button.check_schedule').click(function(){
  ...
  if(!$('input#class_units').val()){
    has_error = 1;
    $('input#class_units').parent().addClass('has-error');
  }else{
    $('input#class_units').parent().removeClass('has-error');
    var class_units = $('input#class_units').val();
  }
...
*/
  ...
  if(days==''){
    has_error = 1;
    $('input#day_sun').parent().parent().parent().parent().addClass('has-error');
  }else{
    $('input#day_sun').parent().parent().parent().parent().removeClass('has-error');
  }
