	...
	<div class="nav nav-stacked affix-top" id="sidebar" >
		<div class="side-tools clearfix"  id="my-other-element">
			...
			<?php /*	<li>
				...
				<?php if($this->session->userdata('is_admin') ==  1 || $this->session->userdata('user_id') == 6 || $this->session->userdata('user_id') == 32 ||  $this->session->userdata('induction_archive_upload') == 1 ): ?>		
					<li>
