...
<div id="main-sidebar" class="main-sidebar main-sidebar-right right-sb-oc" style="display:none">
	<div class="section">
	<!--  -->
		...
		<div class="" >
			...
			<div class="note_side_area">
				...
				<div class="notes_side_form m-top-15 clearfix" <?php echo (isset($project_id) ? '' : ' style="display:none;"'); ?>>
					<textarea class="form-control notes_comment_text upper_c_first_word_sentence" rows="5" id="notes_comment_text" placeholder="Comments"></textarea>
