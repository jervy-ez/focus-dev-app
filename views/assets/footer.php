	<div class="container-fluid">
        ...
        <?php }else{ ?>
        <div class = "col-sm-offset-10 col-sm-2 text-right pull-right" style = "position: fixed; bottom: 0px; background-color: #888">
          <div class="btn-group dropup pull-right">
            <a class="btn dropdown-toggle" data-toggle="dropdown" style = "color: white" id = "show_userlist">
              Users Currently Logged-in
              <span class="caret"></span>
            </a>
            <div id = "user_list" class="dropdown-menu pad-5" style = "width: 250px; text-align: left">
            </div>
          </div>
        </div>
        <?php  }?>
