...
class Shopping_center_m extends CI_Model{
	...
	public function insert_new_shopping_center($shopping_center_brand_name, $detail_address_id){
		$this->db->query("INSERT INTO `shopping_center` (`shopping_center_brand_name`, `detail_address_id`) VALUES ( '$shopping_center_brand_name', '$detail_address_id')");
	...
	public function update_shopping_center($shopping_center_id,$shopping_center_brand_name,$detail_address_id){
		$this->db->query("UPDATE `shopping_center` SET `shopping_center_brand_name` = '$shopping_center_brand_name', `detail_address_id` = '$detail_address_id' WHERE `shopping_center`.`shopping_center_id` = '$shopping_center_id' ");
	}
